...
#### **Шаги нахождения:**
1. Найдите \( \bar{x} \) (среднее выборочное) и \( s \) (выборочное стандартное отклонение).
...
#### **Формула**
Доверительный интервал для дисперсии строится на основе распределения \( \chi^2 \). Формула:
\[
