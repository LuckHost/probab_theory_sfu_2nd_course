...
Это такой интервал, который **накрывает** с заданной вероятностью неищвекстное значение параметра распределения этой случайной величины

Другими словами, это интервал, в который попадают измеренные в эксперименте значения, соответстваующие доверительной верятности

Доверительная вероятность обозначается как 1-a, где **a - уровень значимости**
Например для 95% a = 0.05.
...
#### **Формула**
Доверительный интервал для дисперсии строится на основе распределения \( \chi^2 \) (хи-квадрат). Формула:
\[
